...
class ShowSeriesCardinalityStatementTest
        extends GenericStatementTest<ShowSeriesCardinalityStatement> {
    private static final List<TestBody<ShowSeriesCardinalityStatement>> TEST_BODIES =
            List.of(
                    new TestBody.Builder<ShowSeriesCardinalityStatement>()
                            .withStatement(new ShowSeriesCardinalityStatement.Builder())
                    ...
                    new TestBody.Builder<ShowSeriesCardinalityStatement>()
                            .withStatement(
                                    new ShowSeriesCardinalityStatement.Builder()
                                            ...
                                            .offset(10))
                            .withExpectedSql(
                                    "SHOW SERIES EXACT CARDINALITY ON db FROM \"name\" WHERE e = '20' GROUP BY dimension LIMIT 1 OFFSET 10")
                            .build());
}
