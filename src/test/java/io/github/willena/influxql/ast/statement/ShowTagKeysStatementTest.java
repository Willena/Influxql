...
class ShowTagKeysStatementTest extends GenericStatementTest<ShowTagKeysStatement> {
    private static final List<TestBody<ShowTagKeysStatement>> TEST_BODIES =
            List.of(
                    new TestBody.Builder<ShowTagKeysStatement>()
                            .withStatement(new ShowTagKeysStatement.Builder())
                    ...
                    new TestBody.Builder<ShowTagKeysStatement>()
                            .withStatement(
                                    new ShowTagKeysStatement.Builder()
                                            ...
                                            .sOffset(11))
                            .withExpectedSql(
                                    "SHOW TAG KEYS ON db FROM \"name\" WHERE oooo = 10 ORDER BY \"name\" DESC LIMIT 1 OFFSET 10 SLIMIT 2 SOFFSET 11")
                            .build());
}
