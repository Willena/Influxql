...
class SelectStatementTest extends GenericStatementTest<SelectStatement> {
    private static final List<TestBody<SelectStatement>> TEST_BODIES =
            List.of(
                    ...
                    new TestBody.Builder<SelectStatement>()
                            .withStatement(
                                    new SelectStatement.Builder()
                                            ...
                                            .from(Measurement.measurement("MyMeasurement"))
                                            .groupBy(
                                                    Dimension.field("COLA"),
                                                    Dimension.sampledBy(Duration.ofHours(1)))
                                            .fill(FillOption.NUMBER, IntegerLiteral.of(123)))
                            .withExpectedSql(
                                    ...
                                    new SelectStatement.Builder()
                                            ...
                                            .where(
                                                    BinaryExpression.and(
                                                            BinaryExpression.eq(
                                                                    VarRef.of("toto"),
                                                                    IntegerLiteral.of(56)),
                                                            BinaryExpression.lt(
                                                                    VarRef.of("time"),
                                                                    TimestampLiteral.of(
                                                                            Instant.parse(
                                                                                    "2020-05-16T00:00:00.000000153Z")))))
                                            .orderBy(SortField.desc("time")))
                            .withExpectedSql(
                                    ...
                                    new SelectStatement.Builder()
                                            .select(
                                                    new Field.Builder()
                                                            ...
                                                            .withAlias("alias")
                                                            .build())
                                            .orderBy(new SortFields(List.of(SortField.asc("iii"))))
                                            .fill(FillOption.NUMBER, IntegerLiteral.of(11))
                                            .from(Measurement.measurement("MyMeasurement")))
                            .withExpectedSql(
                                    "SELECT tutu AS alias FROM MyMeasurement fill(11) ORDER BY iii ASC")
                            .build());
}
