...
class CreateContinuousQueryStatementTest
        extends GenericStatementTest<CreateContinuousQueryStatement> {

    public static final List<GenericStatementTest.TestBody<CreateContinuousQueryStatement>>
            TEST_BODIES =
                    List.of(
