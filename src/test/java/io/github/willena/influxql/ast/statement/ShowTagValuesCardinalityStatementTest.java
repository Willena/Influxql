...
class ShowTagValuesCardinalityStatementTest
        extends GenericStatementTest<ShowTagValuesCardinalityStatement> {
    private static final List<TestBody<ShowTagValuesCardinalityStatement>> TEST_BODIES =
            List.of(
                    new TestBody.Builder<ShowTagValuesCardinalityStatement>()
                            .withStatement(new ShowTagValuesCardinalityStatement.Builder())
                                    ...
                                    new ShowTagValuesCardinalityStatement.Builder()
                                            ...
                                            .where(
                                                    new BinaryExpression(
                                                            VarRef.of("kkk"),
                                                            StringLiteral.of("oooo"),
                                                            Operator.NEQ))
                                            .limit(1)
                                            .offset(10))
                            .withExpectedSql(
                                    "SHOW TAG VALUES EXACT CARDINALITY ON db FROM \"name\" WITH KEY = value WHERE kkk != 'oooo' GROUP BY \"field\" LIMIT 1 OFFSET 10")
                            .build());
}
