...
class ShowStatsStatementTest extends GenericStatementTest<ShowStatsStatement> {
    private static final List<TestBody<ShowStatsStatement>> TEST_BODIES =
            List.of(
                    new TestBody.Builder<ShowStatsStatement>()
                            .withStatement(new ShowStatsStatement.Builder())
                            .withExpectedSql("SHOW STATS")
                            .build(),
                    new TestBody.Builder<ShowStatsStatement>()
                            .withStatement(new ShowStatsStatement.Builder().for_("mod"))
