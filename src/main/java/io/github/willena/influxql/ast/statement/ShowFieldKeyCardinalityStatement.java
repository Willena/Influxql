...
public class ShowFieldKeyCardinalityStatement implements Statement {
    ...
    public static final class Builder implements Buildable<ShowFieldKeyCardinalityStatement> {
        ...
        /**
         * Returns a {@code ShowFieldKeyCardinalityStatement} built from the parameters previously set.
         *
         * @return a {@code ShowFieldKeyCardinalityStatement} built with parameters of this {@code ShowFieldKeyCardinalityStatement.Builder}
         */
