...
public class ShowFieldKeyCardinalityStatement implements Statement {
    ...
    private ShowFieldKeyCardinalityStatement(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        ShowFieldKeyCardinalityStatement that = (ShowFieldKeyCardinalityStatement) o;
    ...
    public static ShowFieldKeyCardinalityStatement parse(String sql) {
        return DefaultParser.parseFrom(
                InfluxqlParser::show_field_key_cardinality_stmt,
                (c, a) -> a.visitShow_field_key_cardinality_stmt(c),
                sql);
    }

    /** {@code ShowFieldKeyCardinalityStatement} builder static inner class. */
    public static final class Builder implements Buildable<ShowFieldKeyCardinalityStatement> {
        ...
        /**
         * Returns a {@code ShowFieldKeyCardinalityStatement} built from the parameters previously
         * set.
         *
         * @return a {@code ShowFieldKeyCardinalityStatement} built with parameters of this {@code
         *     ShowFieldKeyCardinalityStatement.Builder}
         */
        public ShowFieldKeyCardinalityStatement build() {
            return new ShowFieldKeyCardinalityStatement(this);
        }
    }
}
